 ...
 *
 */
public class ItemCanoe extends ItemBoat
{
    ...
    {
        super();
        setUnlocalizedName(Bark.MODID + "_birch_canoe");
        setTextureName(Bark.MODID + ":birch_canoe");
        setCreativeTab(Bark.customTabSpices);
    }

    /**
     * Called whenever this item is equipped and the right mouse button is pressed.
     * Cut & pasted from ItemBoat because there's no place to hook in our own entity. Only difference 
     * is it creates our own ItemCanoe instead of standard ItemBoat.
     * @param itemStack
     * @param world
     * @param entityPlayer
     */
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntityBoat entityboat = new EntityCanoe(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
