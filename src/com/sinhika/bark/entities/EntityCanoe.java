...
{
	/* make these stupid fields PROTECTED, not private (bad Mojang!) so children can
	 * inherit without re-writing half the class methods.
	 */
	...
	public EntityCanoe(World par1World) {
		super(par1World);
     ...
     * posY, posZ, yaw, pitch. copied because accesses *new* protected variables that are same name as hidden
     * private variables.
     */
    @SideOnly(Side.CLIENT)
     ...
     * copied because accesses *new* protected variables that are same name as hidden
     * private variables.
     */
    @SideOnly(Side.CLIENT)
	...
	/* (non-Javadoc)
	 * @see net.minecraft.entity.item.EntityBoat#onUpdate()
	 */
	...
	public void onUpdate() 
	{
        ...
        else
        {
            ...
            // We removed the 'break on collision' code here.
            // birchbark canoes are resilient.
